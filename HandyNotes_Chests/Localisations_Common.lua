...
elseif ns.locale == "zhTW" then
	...
	ns.L["Completed"] = "完成"
	ns.L["Not Completed"] = "未完成"
	ns.L["Try again"] = "請再試一次。 伺服器無回應"
	ns.L["ZidormiWrongPhase"] = "你的地圖顯示區域的時間線不對。如果你現在在區域內，那麼你必須去找希多爾米對話。"
	ns.L["Options"] = "選項"
	ns.L["Map Pin Size"] = "地圖圖示大小"
	ns.L["The Map Pin Size"] = "地圖圖示大小"
	ns.L["Map Pin Alpha"] = "地圖圖示透明度"
	ns.L["The alpha transparency of the map pins"] = "地圖圖示透明度"
	ns.L["Show Coordinates"] = "顯示座標"
	ns.L["Show Coordinates Description"] = "在世界地圖和小地圖上的浮動提示中顯示座標"
	...
	ns.L["Right"] = "右"
	ns.L["Notes"] = "簡介"
	ns.L["MinimapMenu"] = "打開該介面的快捷方式可以通過小地圖插件"
		    .."選單，它就在日曆圖示的下方。 只需點擊滑鼠\n\n"
	ns.L["ChatCommands"] = "還支援輸入命令打開方式，輸入。 "
	ns.L["ShowPanel"] = " - 顯示設定選項\n"
	ns.L["TryMinimapMenu"] = "也可以在插件選單打開 (小地圖日曆圖示下方)"
