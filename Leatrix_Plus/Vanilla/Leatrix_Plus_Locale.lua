...
L["Disable loot warnings"] = "禁用交易/Roll点确认"
...
L["Drag to set the font size of book text."] = "拖动以调整书籍字体的大小。"
...
L["Drag to set the scale of the flight map."] = "拖动以设置飞行地图的大小。"
...
L["Hinterlands"] = "辛特兰"
L["Hold ALT and drag the flight map to move it."] = "按住ALT并拖动飞行地图来移动它。"
L["Home"] = "主页"
L["Horned"] = "角马"
...
L["If checked, a minimap button will be available.|n|nClick - Toggle options panel.|n|nSHIFT-click - Toggle music.|n|nALT-click - Toggle errors (if enabled).|n|nCTRL/SHIFT-click - Toggle windowed mode.|n|nCTRL/ALT-click - Toggle Zygor (if installed)."] = "勾选后，小地图按钮将可用。|n|n点击 - 开关选项面板。|n|nSHIFT+点击 - 开关音乐。|n|nCTRL+点击 - 开关小地图目标追踪。|n|nALT+点击 - 开关错误显示(如果启用)。|n|nCTRL+SHIFT+点击 - 切换窗口/全屏模式。|n|nCTRL+ALT+点击 - 开关Zygor插件(如果已安装)。 "
L["If checked, a minimap button will be available.|n|nClick - Toggle options panel.|n|nSHIFT-click - Toggle music.|n|nCTRL-click - Toggle minimap target tracking.|n|nALT-click - Toggle errors (if enabled).|n|nCTRL/SHIFT-click - Toggle windowed mode.|n|nCTRL/ALT-click - Toggle Zygor (if installed)."] = "勾选后，小地图按钮将可用。|n|n点击 - 开关选项面板。|n|nSHIFT+点击 - 开关音乐。|n|nCTRL+点击 - 开关小地图目标追踪。|n|nALT+点击 -开关错误显示(如果启用)。|n|nCTRL+SHIFT+点击 - 切换窗口/全屏模式。|n|nCTRL+ALT+点击 - 开关Zygor插件(如果已安装)。"
...
L["If checked, the zone text bar will be hidden."] = "勾选后，隐藏切换地图时显示在界面上方的区域文本信息。"
...
L["If checked, you can block spell links, drunken spam and duel spam."] = "勾选后，你可以屏蔽含法术链接的信息，醉酒提示以及决斗提示。"
...
L["If checked, you can press the arrow keys to move the insertion point left and right in the chat frame.|n|nIf unchecked, the arrow keys will use the default keybind setting."] = "勾选后，你可以使用方向键移动文本框中的光标。|n|n如果未被勾选，方向键将保持它所绑定的快捷键。"
L["If checked, you will be able to cancel cinematics without being prompted for confirmation."] = "勾选后，你无需确认即可快速跳过过场动画。"
...
L["If checked, zone text will not be shown (eg. 'Ironforge')."] = "勾选后，切换地图时浮动在屏幕上方的区域文本不再显示。"
L["If you toggle an addon minimap button, you may need to reload your UI for the change to take effect.  This only affects a few addons that use custom buttons."] = "如果您切换插件小地图按钮，您可能需要重载UI才能使变更生效。这仅影响一些使用自定义图标的插件。"
...
L["If checked, all profession transforms added in Dragonflight will be removed when applied."] = "Si cette option est cochée, toutes les transformations de profession ajoutées dans Dragonflight seront supprimées une fois appliquées."
...
L["If checked, the following junk items required to purchase pets from Keeper Ta'hult in Oribos will not be sold automatically."] = "Si cette option est cochée, le bric-à-brac nécessaire pour acheter des animaux de compagnie auprès du gardien Ta'hult à Oribos ne seront pas vendus automatiquement."
