...
L["If checked, quests will be selected, accepted and turned-in automatically.|n|nQuests which require gold, currency, a crafting reagent or an account-bound item will not be turned-in automatically."] = [=[퀘스트 자동 수락 및 완료.
골드, 통화, 제작 재료 또는 계정에 귀속된 아이템이 필요한 퀘스트는 제외.]=]
...
L["If checked, emote sounds will be silenced while your character is:|n|n- resting|n- in a pet battle|n- at the Halfhill Market|n- at the Grim Guzzler|n|nEmote sounds will be enabled when none of the above apply."] = "Si está seleccionado, los sonidos de emociones serán silenciados si: |n|n- descansando|n- duelo de mascotas|n- en El Mercado del Alcor|n- en El Tragapenas|n|nLos sonidos de emociones se activarán cuando no se aplique nada de lo anterior."
...
L["Sell"] = "Vender"
L["Sell junk automatically"] = "Vender objetos de baja calidad"
...
L["If checked, furlines will be muted.|n|nThis applies to Sunwarmed Furline."] = "Si cette option est cochée, les féligres seront désactivées.|n|nCeci s'applique au Féligre mordoré."
...
L["If checked, party invitations from friends will be automatically accepted unless you are queued in Dungeon Finder."] = "Si cette option est cochée, les invitations de groupe par les amis seront automatiquement acceptées, sauf si vous êtes en file d'attente dans une recherche de groupe."
...
L["If checked, requests initiated by your party leader to join the Dungeon Finder queue will be automatically accepted if the party leader is a friend.|n|nThis option requires that you have selected a role for your character in the Dungeon Finder window."] = "Si cette option est cochée, les demandes initiées par votre chef de groupe pour rejoindre la file d'attente de recherche groupe seront automatiquement acceptées si le chef de groupe est un ami.|n|nCette option nécessite que vous ayez sélectionné un rôle pour votre personnage dans la fenêtre recherche groupe."
L["If checked, requests initiated by your party leader to join the Dungeon Finder queue will be automatically accepted if the party leader is in your friends list or guild.|n|nThis option requires that you have selected a role for your character in the Dungeon Finder window."] = "Si cette option est cochée, les demandes initiées par votre chef de groupe pour rejoindre la file d'attente de recherche groupe seront automatiquement acceptées si le chef de groupe est dans votre liste d'amis ou votre guilde.|n|nCette option nécessite que vous ayez sélectionné un rôle pour votre personnage dans la fenêtre recherche groupe."
