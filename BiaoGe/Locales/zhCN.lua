...
do --简体说明书
    ns.instructionsText = {
        "|cff00BFFF< 说明书 >（本插件支持WLK、60服，不再支持CTM、探索赛季）|r\n\n",
        ...
        [[-拍卖WA更新为v2.2：按加价时，可以直接把出价设置为合适的价格]] .. "|r\n",
        [[-团长拍卖面板：增加一键开拍（在设置里可以更改预设价格）]] .. "|r\n",
        [[-装备过滤：增加多个图标]] .. "|r\n",
        [[-修复了[集结号多个关键词搜索]导致黑名单失效的问题]] .. "|r\n",
        [[-<WLK>团员成就：增加"我来组成头部！"]] .. "|r\n",
        [[-<赛季服>增加一个世界Boss表格，删除黑石塔表格]] .. "|r\n",
        [[-<赛季服>更新P5装备库]] .. "|r\n",
        [[-<赛季服>现在会自动记录蓝色品质的图纸到表格里]] .. "|r\n",
        [[-<赛季服>角色总览：增加货币[褪色的安德麦雷亚尔] ]] .. "|r\n",
        [[-<赛季服>装备过滤：词缀"治疗强度"现在会正确过滤治疗装备]] .. "|r\n",
        [[-<赛季服>修复了右键菜单里密语模板按钮丢失的问题。修复了黑龙本不会自动清空表格的问题]] .. "|r\n\n",
        "|cff00FF00" .. "10月18日更新v1.12.8" .. "|r\n",
        [[-修复了拍卖记录里匿名模式的最后5手出价记录没有正确显示的问题]] .. "|r\n",
        [[-修复了交易时自动摆放装备偶尔不生效的问题]] .. "|r\n\n",
