...
st.timbermaw = "注意，前往冬泉谷時，你會\n經過木喉要塞。這是一個\n"
			.."兩難的局面：殺死怪物會降低你與該陣營的聲望。\n首先決定你是否真的想先提升到友善"

-- 德魯伊 第一階段
st.druid.ferocious = "可從西部荒野的眾多河爪豺狼人身上取得，\n黑海岸的巢穴母親、銀松森林的蒼白格里姆森\n"
			.."以及貧瘠之地三個半人馬的箱子取得。\n\n取得並裝備後，對人型生物造成 20 次流血\n"
			.."傷害。再次點擊神像以最終啟動。"
st.druid.ursineRage = "聯盟可以殺死泰達希爾的狂爪。\n部落可以殺死莫高雷的風險投資公司監工或\n"
			.."剛鬃入侵者。\n\n兩個陣營都可以擊殺平原徘徊者、\n草原狼首領、利爪俯衝者、\n風怒女族長和女巫。\n\n"
			.."查看神像的提示。保持怒氣！"
st.druid.idolWild = "只要拾取怪物掉落物。然後裝備/右鍵點擊。\n對友善生物進行 10 次直接治療。\n"
			.."現在再次點擊神像。"
st.druid.lunarIdolA = "在 4 級以上時從莫丹特·硬橡處\n取得卡多雷的遺物任務。\n\n"
			.."殺死格雷爾金以取得月神神像。裝備。\n\n現在殺死 6 個受月火術影響的怪物。\n現在再次點擊神像。"
st.druid.lunarIdolH = "前往荊棘刃峽谷。\n\n拾取箱子並裝備\n\n現在殺死 6 個受月火術影響的怪物。\n"
			.."現在再次點擊神像。"
st.druid.naturalPotential = "從莫高雷收集 3 朵草原之花 (部落),\n從泰達希爾收集 3 朵林地之花 (聯盟)。\n\n"
			.."組合成草原/林地花冠。\n\n前往 (37.60,49.50) (部落) 或 (66.90,57.70) (聯盟)。\n\n"
			.."等待木質雕像生成。\n對其使用花冠。殺死靈魂。拾取。"
st.druid.lacerate = "聯盟最好前往洛克莫丹湖邊的卡拉深水。\n購買一些彩虹鰭金槍魚誘餌 (5 銀)，然後餵給\n"
			.."湖中的幼年瑟斯加頓。\n\n"
			.."部落應該前往貧瘠之地，尋找一個\n廢棄的碎顎巢穴。抓取蛋並\n"
			.."將其放入空的碎顎巢穴中。等待，\n然後點擊幼體以取得你的戰利品！\n\n"
			.."兩個陣營都可以前往黑海岸。擊殺\n黑木怪物以取得螃蟹零食或釣魚取得。\n"
...
st.druid.runeOfStars = "找到格魯吉姆德恩，在一座小橋下。\n然後前往樹樁。只有在樹樁處\n"
			.."你才應該吃掉蘑菇。接下來的步驟會自動進行。\n\n在有幫助或靈魂狀態下可以提早完成。"
st.druid.runeOfTheSun = "部落前往莫高雷，對三個附近的月石\n施放月火術。聯盟必須前往泰達希爾，\n"
			.."並注意其中兩個石頭在樹枝上。\n現在點擊月之寶箱。是的，很簡單！"
st.druid.swim = "從東邊的雕像/地圖標記開始。\n(如果你分析地形，你就會明白為什麼)。\n"
			.."以水生形態游到西邊的雕像，爬上去並點擊\n"
			.."以取得你的獎勵。以水生形態，從東\n到西，你會有充足的時間。"
st.druid.wildGrowth = "大約在 21 級以上時，前往月光林地的\n你的訓練師洛加納爾。開始貓頭鷹的試煉。\n"
			.."注意：你可以在接任務之前\n取得三隻貓頭鷹。第一隻貓頭鷹：梣谷，\n"
			.."第二隻貓頭鷹：暮色森林，第三隻貓頭鷹：希爾斯布萊德丘陵。\n只需交任務即可獲得你的符文！"

-- 德魯伊 第二階段
st.druid.berserk = "在扎伊恩基/野獸雕像的位置使用挑戰咆哮 (28 級)。殺死並獲利。"
st.druid.dreamstate = "殺死科卡爾半人馬 (30-31 級)\n直到他們掉落乾燥的種莢。\n\n"
			.."向南走，在任何池塘中游泳，直到它\n重新水化 ->  薩特草鱗莖。\n\n"
			.."現在向北前往薩格隆廢墟，\n將鱗莖種植在沙質壤土堆中。\n"
			.."點擊它以獲得你的豐厚戰利品符文！"
st.druid.nourish = "殺死一個腐爛的古樹，40 級，以獲得\n腐爛的種子並開始“迷失的古樹”。\n\n"
			.."你現在必須與月光林地的奧羅凱交談。\n\n小心，因為後續任務有 1 小時的時間限制，\n"
			.."而且你不能死亡、使用爐石、傳送、接受\n法師傳送門等任何方式移動。\n\n((船/飛艇/飛行路線\n"
			.."是可以的，但在 PvP 伺服器上會受到限制))\n\n你必須在奧特蘭克山脈、阿拉希高地、\n悲傷沼澤和荊棘谷中給一棵古樹幼苗澆水，\n順序不限。最佳選擇是將荊棘谷放在最後，\n因為你必須返回奧羅凱。"

-- 德魯伊 第三階段
st.druid.efflorescence = "從菲拉斯的泰里修斯處接取“守護者的智慧”任務 (45 級)。你現在必須拜訪三位守護者之魂。\n\n"
			.."艾薩拉：殺死漫遊的阿帕羅之子。免疫法術，所以以熊/貓形態進行物理攻擊。在野獸神殿獻上掉落的心臟。召喚並殺死低語之翼。\n\n"
			.."菲拉斯：對自己使用移除詛咒和治療毒藥。與食人魔和毒刺鞭笞者戰鬥以獲得這些效果。完成後你將獲得守望者的標記增益。在神殿殺死枯萎樹皮。\n\n"
			.."辛特蘭：在月之樹形態下對自己施放寧靜，然後施放颶風。智羽將會生成。殺死它。"
st.druid.elunesFires = "前往艾薩拉西部哈爾達爾營地山丘頂部的破損神殿。\n\n"
			.."拾取旅行者的背包：凱爾達拉的日誌和研缽與杵。\n\n"
			.."從神殿場地取得 3 個薩特草樣本。使用研缽與杵 ->  酊劑。\n\n"
			.."對一隻腐化的 (綠色) 角鷹獸施放冬眠術，可以在西北方向找到。現在使用酊劑。\n\n"
			.."檢查你的背包以取得戰利品。"
st.druid.improvedBarkskin = "學習樹皮術 (44 級) 後，前往塔納利斯西南角，擊殺\n蒺藜灌木露水收集者 (47-48 級)\n以獲得狂暴踐踏者的神像。\n\n"
			.."裝備神像。在樹皮術增益狀態下擊敗 5 個敵人。這會為神像充能五次。右鍵點擊它。"

-- 德魯伊 第三階段
st.druid.impSwipe = "從塔納利斯進入安戈洛環形山，殺死\n暴龍直到掉落獵人的神像。裝備它。\n\n"
			.."在貓形態下，對五個\n怪物施放冬眠術。殺死它們。\n\n再次右鍵點擊神像即可獲勝！"
st.druid.treeOfLife = "在鐵木森林西北方向遇到復仇的精靈。繼續向西北方向前往\n翡翠之火小徑。\n\n"
			.."擊殺翡翠之火的薩特直到你\n獲得閃爍之光增益。\n\n"
			.."與你的精靈朋友交談，它會\n掉落一個禮物。那就是你的豐厚戰利品！"


-- 獵人 第一階段
st.hunter.beastMastery = "在西部荒野擊殺眾多血牙野豬以取得血牙野豬後腿肉，然後用它來召喚銀鬃。殺死並拾取，西部荒野；或在黑海岸擊殺毛皮怪以取得螃蟹零食。然後餵給海岸上的幼年礁石爬行者 (聯盟)；\n\n"
			.."部落必須殺死兇猛的灰熊，直到生成一隻灰熊守護者，銀松森林。殺死，拾取；\n"
			.."在貧瘠之地陶拉祖營地以北，捕捉一隻巡邏的獵豹。你現在可以殺死它了。豐厚戰利品！(部落)"
st.hunter.carve = "從丹莫羅的戈爾巴採石場的石顎穴居怪身上取得兔子麝香，然後在兔子小動物身上使用麝香。現在馴服它。與丹莫羅琥珀松木牧場的托比交談以獲得你的獎勵；\n\n"
			.."在泰達希爾，從 gnarlpine 身上取得鹿麝香。對鹿使用。馴服。與達納蘇斯的雷拉艾隆交談 (聯盟)；從杜隆塔爾的剃刀嶺身上取得響尾蛇費洛蒙。剃刀嶺的拉茲爾；\n"
			.."莫高雷是從白鬃身上取得的草原土撥鼠麝香。血蹄村的塔科達·日鬃 (部落)。\n\n"
			.."請注意，當你馴服你的小動物時，你不需要放棄你目前的同伴。"
st.hunter.cobraStrikes = "從在南海鎮和塔倫米爾之間遊蕩的齊希爾處購買淡水鯛魚誘餌。\n\n"
			.."現在在塔倫米爾以南湖上的小船上... 使用小船。科爾圖爾出現了！"
st.hunter.explosiveShot = "丹莫羅的費奧迪、嚎叫者埃丹、Mangeclaw、老冰鬚、Timber、Vagash；泰達希爾班艾西爾巴羅底部的狂爪 (聯盟)；被大量佔據的薩科斯，試煉谷；莫高雷的Arra'chea、幽靈嚎叫、Mazzranache、The Rake (部落)"
st.hunter.flankingStrike = "丹莫羅冰湖東側洞穴中的喬魯爾；(聯盟)神諭林地河流東側洞穴中的莫格；\n"
			.."杜隆塔爾回音群島北部島嶼的拉魯克；莫高雷血蹄村西北方西部的莫克瓦 (部落)\n\n"
			.."要生成稀有怪，你必須擊殺它所需的食物。詳見提示\n\n這些稀有怪是跨陣營的。在擊殺或馴服時獲得符文 (10 級)。熊 (聯盟) 和貓 (部落) 的技能和屬性只是平均水平。"
st.hunter.heartLion = "濕地的塞爾根岩洞後方的卡羅丁 (聯盟/部落)"
st.hunter.killCommand = "這個過程圍繞著石爪山脈通往風剪峭壁路徑上的吉克索·瘋火箭展開。\n\n"
			.."第一個任務需要你殺死吞噬者穆塔努斯，它位於哀嚎洞穴的盡頭。穆塔努斯掉落催眠水晶。哀嚎洞穴副本位於貧瘠之地。\n\n"
			.."你還需要一根粗糙的野性魔法杖。從拍賣行/附魔師朋友那裡購買一根高級魔法杖。與梣谷毛皮怪掉落的野性魔法精華組合。\n\n"
			.."第二個任務需要你目睹吉克索馴服一隻雙足飛龍。非常簡單！\n\n"
			.."獵人的額外獎勵是我們可以獲得一根雙足飛龍馴服魔杖，它可以讓我們馴服石爪山脈的幼年驕傲之翼。我也標記了它們！"
st.hunter.masterMark = "對沙沙作響的灌木叢使用獵人印記。一個盜獵者將會出現。殺死它。拾取它。"
st.hunter.sniper = "黑海岸瑪希絲特拉廢墟以西的帕克斯諾茲；西部荒野哨兵嶺的迪菲亞斥候；洛克莫丹湖的卡克爾 (聯盟)。\n\n貧瘠之地棘齒城海岸外的布魯茲 (部落)"

-- 獵人 第二階段
st.hunter.dualWield = "在這個位置你會獲得一個“危險！”增益。\n\n在這個區域遊蕩，使用你的“照明彈”(32 級)\n"
			.."直到你找到血頭皮游擊隊 (34 級)。同時使用追蹤隱形。\n\n殺死並拾取。"
st.hunter.expose = "擊殺食人魔和穴居怪，直到掉落原始圖畫。然後前往荊棘谷北部的赫米特·奈辛瓦里的營地。他會把你送回荒蕪之地，並給你一個籠子。\n\n"
			.."在下次遭遇之前，捕捉任何小動物。\n\n回到荒蕪之地，找到大巢穴並\n"
			.."召喚加里克，一隻 40 級的鳥。馴服或擊敗以\n獲得深紅色戰利品羽毛。返回赫米特。"

-- 獵人 第三階段
st.hunter.calefactus = "追蹤野獸是你的朋友。可馴服 (50 級)。\n一隻綠色的熔火之心風格的熔岩獵犬！\n對於任務，必須殺死 :("
st.hunter.catlike = "在雪人洞穴後部上層角落找到嬰兒雪人。餵它泰拉比姆香蕉或柔軟的香蕉麵包。\n\n"
			.."你有十分鐘的時間護送嬰兒到它附近的母親身邊。嬰兒具有攻擊性，所以沿途會有戰鬥。\n\n"
			.."母親在外面的一個小土丘上。"
st.hunter.focusFire = "地圖位置附近有一座橋，橋附近有一個樹枝和一個鳥巢。拾取蛋。\n\n"
			.."殺死生成的憤怒的風暴烏鴉。拾取 -> 獲利。"
st.hunter.rapidKilling = "進入灼熱峽谷西北角的火警山脊洞穴。上部中間部分。\n"
			.."與柱子上的風化蝕刻互動。\n\n現在前往詛咒之地與琳諾爾會面。\n"
			.."她在通往悲傷沼澤的最北端，在恐懼之槌要塞一側。\n\n"
			.."對於她的第一個任務，避開她西南方的暗影誓言儀式師，因為他們更強大。\n\n"
			.."卡利法克圖斯是一個獨特的熔岩獵犬模型，你也可以在完成“使其屈服”任務時馴服它。\n\n"
			.."請注意，你會獲得一個很棒的飾品，特別有助於馴服熔火之心的熔岩獵犬。BoPU"

-- 獵人 第四階段
st.hunter.hitAndRun = "逃脫的熔岩獵犬 (60 級)\n掉落游擊隊的符文。"
st.hunter.resourceful = "這個符文的整個過程都發生在\n東瘟疫之地。\n\n"
			.."分別殺死軟泥怪和瘟疫野豬以獲得\n沸騰的綠色腐液和受污染的野豬肉。\n\n"
			.."將其中一個組合起來製作一塊腐臭的肉塊，\n然後餵給眾多的腐肉蛆蟲。\n\n"
			.."它會吐出一個反芻的骨架，\n在骨架裡面就是你的符文！"
st.hunter.volley = "在希利蘇斯擊殺任何怪物以獲得損壞的小裝置。\n\n現在拜訪希利蘇斯最南端的艾德維·銅栓，\n他會給你一個沙漠聲納。\n\n"
			.."用這個你可以找到沙蟲 (60 精英)，\n在地圖上標記了。殺死以獲得豐厚戰利品。"

-- 法師
st.mage.books = "在艾澤拉斯收集書籍可以獲得四個符文。任何列出的書籍都有效。\n"
			.."你將發現的每一本書都交給幽暗城的歐文·薩德 (部落) 或暴風城的加里昂·溫德爾 (聯盟)。\n\n"
			.."你可以單獨或一次提交多本書。當你提交足夠的書籍以獲得符文時，一個\n"
			.."簡單的完成任務將獎勵你你的符文。"
st.mage.bookStart = " 艾澤拉斯各地的書籍，數量太多，這裡無法一一列舉，但是...\n"
			.."請參閱我的詳細指南：暴風城法師塔傳送門房間的加里昂·溫德爾 (聯盟)\n"
			.."或幽暗城法師區的歐文·薩德 (部落)"
...
st.mage.booksQuestNamesA = {
			"盧德主義者寵物護理指南" ..colourPlaintext .."    在悲傷沼澤擊殺迷失者",
			"金屬之心" ..colourPlaintext .."    在灼熱峽谷一個帳篷裡的桌子上",
			"光的學派" ..colourPlaintext .."    在聖光之願禮拜堂的左後角",
			"謊言之網：揭穿神話和傳說" ..colourPlaintext .."    在一個帳篷旁邊。阿拉希的冬泉村",
			"奧術系統手冊" ..colourPlaintext .."    貧瘠之地的污泥沼澤",
			"大法師安東尼達斯：未刪節的自傳" ..colourPlaintext .."    鐵爐堡的探險者大廳",
			"大法師西奧克里圖斯的研究日誌" ..colourPlaintext .."    艾爾文森林的阿祖拉之塔",
			"石化蜥蜴：石化應該被恐懼嗎？" ..colourPlaintext .."    荊棘谷水晶礦脈的入口",
			"巴克斯坦：論毀滅魔法" ..colourPlaintext .."    在貧瘠之地棘齒城的加茲洛夫旁邊",
			"迷惑和魅力" ..colourPlaintext .."    西部荒野的月溪鎮",
			"魔術師法典" ..colourPlaintext .."    前往詛咒之地",
			"解剖學罪行" ..colourPlaintext .."    暮色森林的烏鴉嶺墓穴",
			"防禦魔法 101" ..colourPlaintext .."    奧特蘭克山脈的食人魔塔",
			"惡魔與你" ..colourPlaintext .."    在雷霆之斧要塞內",
			"日常禮儀" ..colourPlaintext .."    艾薩拉的赫爾達爾營地",
			"大地之怒" ..colourPlaintext .."    在石爪山脈的 Grimtotems 附近",
			"地卜術：冰冷的真相" ..colourPlaintext .."    在一間小屋內，千針石林的暗雲峰",
			"戈茲卷軸" ..colourPlaintext .."    濕地的維爾加的挖掘場",
			"海潮賢者的傳說" ..colourPlaintext .."    在塔納利斯海盜灣的一棟建築物內",
			"岩漿還是熔岩？" ..colourPlaintext .."    在洛索斯·裂石者之後的露天洞穴內的一個壁架上",
			"木乃伊：令人討厭的不死族指南" ..colourPlaintext .."    荒蕪之地一個台地內的墓穴",
			"納爾薩拉斯年鑑" ..colourPlaintext .."    黑海岸廢墟",
			"通靈學 101" ..colourPlaintext .."    在通靈學院上層一個角落的桌子上。不在副本內",
			"諾莫瑞根的魯米：作品集" ..colourPlaintext .."    塞爾薩瑪或西部荒野旅館",
			"巫妖王的符文" ..colourPlaintext .."    洛克莫丹的食人魔洞穴",
			"RwlRwlRwlRwl！" ..colourPlaintext .."    悲傷沼澤的女巫山魚人營地",
			"血腥魔法" ..colourPlaintext .."    在悲傷沼澤的沉沒神廟頂部",
			"天災：亡靈威脅還是誤解？" ..colourPlaintext .."    就在通靈學院橋之前",
			"夢想者的秘密" ..colourPlaintext .."    在哀嚎洞穴傳送門附近",
			"石雕設計" ..colourPlaintext .."    在黑石山的弗蘭克隆·鍛造之魂的祭壇上",
			"達拉然文摘" ..colourPlaintext .."    銀松森林的琥珀磨坊",
			"騎士與女士" ..colourPlaintext .."    在小房子裡",
			"邊緣與奧術" ..colourPlaintext .."    在菲拉斯的奧尼羅斯，但僅限於夢魘入侵時",
			"不死土豆" ..colourPlaintext .."    在樓上的農舍裡",
			"毒液之旅" ..colourPlaintext .."    在辛特蘭的一堵棕色牆後面",
			"圖書館之友" ..colourPlaintext .."    冰脈的最後一步！",
			"圖書館的摯友" ..colourPlaintext .."    法術強度的最後一步！",
			"圖書館的摯友" ..colourPlaintext .."    深結的最後一步！" }
...
st.mage.booksQuestNamesH = {
			...
			"海潮賢者的傳說" ..colourPlaintext .."    在塔納利斯海盜灣的一棟建築物內",
			"岩漿還是熔岩？" ..colourPlaintext .."    在洛索斯·裂石者之後的露天洞穴內的一個壁架上",
			"木乃伊：令人討厭的亡靈指南" ..colourPlaintext .."    荒蕪之地一個台地內的墓穴",
			"納爾薩拉斯年鑑" ..colourPlaintext .."    黑海岸廢墟",
			"通靈學 101" ..colourPlaintext .."    在通靈學院上層一個角落的桌子上。不在副本內",
			"巫妖王的符文" ..colourPlaintext .."    洛克莫丹的食人魔洞穴",
			"RwlRwlRwlRwl！" ..colourPlaintext .."    悲傷沼澤的女巫山魚人營地",
			...
			"達拉然文摘" ..colourPlaintext .."    銀松森林的琥珀磨坊",
			"騎士與女士" ..colourPlaintext .."    在小房子裡",
			"塔佐的教訓" ..colourPlaintext .."    奧格瑞瑪的靈魂谷",
			"邊緣與奧術" ..colourPlaintext .."    在菲拉斯的奧尼羅斯，但僅限於夢魘入侵時",
			"亡靈土豆" ..colourPlaintext .."    在樓上的農舍裡",
			"毒液之旅" ..colourPlaintext .."    在辛特蘭的一堵棕色牆後面",
			"圖書館之友" ..colourPlaintext .."    冰脈的最後一步！",
			"圖書館的摯友" ..colourPlaintext .."    法術強度的最後一步！",
			"圖書館的摯友" ..colourPlaintext .."    深結的最後一步！" }
...
-- 法師 第一階段
st.mage.enlightenment = "聯盟應該前往艾爾文森林最東邊的脊點塔，儘管任何有小動物的地方都是可行的。如果小動物身上有一個野性變形術減益 (而且它看起來也會“格格不入”)，那就對它使用變形術。當這個人走開時，你會看到一個閃閃發光的物體。\n\n"
			.."部落需要在提瑞斯法林地任何農場周圍尋找奇怪的瓜，並對它使用變形術。\n\n"
			.."該物體的提示會說明你需要多少個。將它們組合在一起 (使用其中一個)。瞧！"
st.mage.arcaneBlast = "娜迦手稿會從怒尾女巫和海巫身上掉落。\n\n"
			.."在地圖上標記的三個粉色/紫色碎片處施放奧術爆炸。\n\n"
			.."大功告成，你是贏家！"
st.mage.fingers = "聯盟需要從一系列受歡迎的舊敵人身上掉落。Timber、Mangeclaw、Bjarm、嚎叫者埃丹、老冰鬚、Hammerspine、Vagash 以及新加入的費奧迪。都在丹莫羅。還有霍格！\n\n"
			.."部落可以獲得加茲烏斯，在你離開奧格瑞瑪時左邊的洞穴裡。回音群島上的扎拉贊對巨魔來說很方便。新加入的吉爾加就在死鐘鎮的北邊。\n\n只要拾取並理解！<3"
st.mage.livingBomb = "在洛克莫丹塞爾薩瑪最南端的碎石者洞穴中的怪物會掉落咀嚼過的法術筆記。同樣的先知也出現在洛克莫丹最北端的湖泊中。\n\n"
			.."部落可以選擇在銀松森林完成一些任務以獲得保證的獎勵。問題是，你需要一個掉落率非常低的“會說話的頭”在你\n"
			.."在芬里斯島完成任務時掉落，才能開始任務鏈。\n\n值得嗎？3% 的掉落率。我寧願去修剪草坪。"
st.mage.livingFlame = "丹莫羅的霜鬃暗影施法者 (聯盟) 和霜鬃先知 (聯盟/部落) 會掉落法術筆記。他們在地圖的西側，並已標記。\n\n"
			.."艾爾文森林碧玉礦內及其周圍的狗頭人地卜師 (聯盟) 也是可能的。\n\n"
			.."在提瑞斯法林地，血色戰士、傳教士和狂熱者 (都是聯盟/部落) 都已標記。\n\n"
			.."杜隆塔爾都是部落的燃燒之刃，甚至就在奧格瑞瑪的外面。\n\n"
			.."和往常一樣，拾取並理解！"
st.mage.regeneration = "部落可以在銀松森林南部擊殺達拉然學徒。\n\n"
			.."理論上，聯盟/部落都可以：在貧瘠之地擊殺科卡爾半人馬以獲得鑰匙來打開該地區的兩個箱子之一；檢查洛克莫丹北島上的一堆被盜的書籍；在西部荒野南部殺死迪菲亞叛徒法師。拾取並理解！"

-- 法師 第二階段
st.mage.chronostatic = "3 或 4 個法師必須對千針石林的三個不同的怪物施放冰霜法術，才能使它們\n"
			.."獲得“冷卻”減益。殺死並拾取。\n\n請注意，美洲獅被關在籠子裡，需要一把鑰匙，\n"
			.."鑰匙從加拉克·捶擊者半人馬身上掉落。\n\n三個怪物都會掉落部分法術筆記，必須將它們\n"
			.."組合起來。"
st.mage.hotStreak = "在斯坦恩布萊德的鐵匠鋪，使用火焰法術點燃兩個風箱。\n\n"
			.."一個遠古火焰元素將會生成。殺死並拾取。"
st.mage.fireAndFrost = "在荊棘谷殺死碎顱秘法師。"

-- 法師 第三階段
st.mage.booksBM = "像你要進入黑石深淵或熔火之心一樣進入黑石山。\n\n"
			.."這本書在弗蘭克隆·鍛造之魂的祭壇房間裡。\n\n你不必死亡就能看到這本書！;)"
st.mage.temporal = "從辛特蘭的貓頭鷹野獸身上收集 1 個原始的貓頭鷹野獸羽毛，從菲拉斯東南部的矽甲蟲身上收集 5 個祖卡什樹脂，\n"
			.."以及從祖爾法拉克的殭屍身上收集 8 個法拉基莎草紙。\n\n"
			.."額外獎勵是一本個人法術書。終於，你可以製造理解護符了！！!"

-- 法師 第四階段
st.mage.frozenOrb = "擊殺枯木怪物直到掉落神秘的暗夜精靈卷軸。\n\n"
			.."像往常一樣，使用你的理解護符。\n\n現在向東南方向前往卡利克斯·綠芒，並對他使用\n"
			.."卷軸！接受任務。\n\n現在向南走，擊殺那些鐵木怪物\n"
			.."直到掉落一個不尋常的燒瓶。\n\n前往冬泉谷，再次尋找\n"
			.."卡利克斯，他就在木喉要塞出口附近。殺死\n"
			.."卡利克斯的靈魂。拾取。獲利！\n\n" ..st.timbermaw
st.mage.magmaLarva = "洛索斯·裂石者在黑石深淵洞穴的入口處，在深處，幾乎與熔岩層齊平，\n"
			.."位於黑石山洞穴的正中央。\n\n經過他前往弗蘭克隆·鍛造之魂的祭壇房間。\n\n"
			.."繼續前進，你現在就在黑石深淵洞穴裡。\n就在這個洞穴的入口處，你會在一個壁架上看到這本書。"
st.mage.overheat = "在四個地點中的每個地點，你都會\n遇到一個被冰凍的新手法師。\n\n"
			.."使用火焰法術解凍他。\n\n在他還活著的時候，使用移除次級詛咒。\n\n"
			.."每個法師都會掉落一張撕裂的法術筆記。\n\n組合所有四張以獲得你的豐厚戰利品！\n\n"
			.."好的... 如何不殺死他們...  交替使用\n1 級火球術和 1 級灼燒。\n"
			.."這很慢，但確實有效。重生時間\n不到一分鐘，順便一提。"
...
-- 聖騎士 第一階段
st.paladin.banishment = "以暮色森林南緣的迪菲亞附魔師、迪菲亞夜刃和迪菲亞夜行者為目標。輕鬆擊殺。\n\n掉落聖契後裝備它。\n\n"
			.."對五個敵人施放亡靈驅散，並用驅邪術殺死他們。\n\n再次點擊聖契。"
st.paladin.blessings = "前往洛克莫丹的塞爾薩瑪旅店。\n它就在那裡的一張桌子上。或者前往\n"
			.."西部荒野，在詹戈洛德礦或黃金海岸採石場殺死不死礦工。\n\n"
			.."按照聖契的提示說明操作。完成！"
st.paladin.divineStorm = "你會在黑海岸北部阿薩拉克斯塔頂部找到一個寶珠。開始一個任務。\n\n"
			.."在梣谷的瑪艾斯特拉哨站尋找淨化者德爾格倫。\n\n"
			.."按照指示，前往暴風城大教堂的純潔者凱瑟琳，她會派你去找位於法師區後面的烏蘇拉·德萊尼。\n\n"
			.."烏蘇拉派你到赤脊山去收集她的鹽。它的掉落率很低 QQ。回到她身邊。\n\n"
			.."烏蘇拉現在需要梣谷的魔塵。\n\n"
			.."收集魔塵後，將它們帶到瑪諾洛斯的祭壇。它又大又紫。點擊地面以提交魔塵。一個破碎的寶珠出現了。把它帶給德爾格倫。終於完成了！"
st.paladin.judgement = "矮人去見安威瑪爾入口的布羅莫斯·格魯姆納，人類去見北郡修道院武器大廳的薩穆爾兄弟。\n\n你現在的任務是在寒冷山谷消滅霜鬃巨魔幼崽或在修道院東邊的葡萄園消滅迪菲亞暴徒。\n\n"
			.."當聖契掉落時，閱讀說明。選擇一個聖印法術，對 10 個敵人施放審判。\n\n"
			.."點擊你的聖契以獲得獎勵。"
st.paladin.justice = "在洛克莫丹的碎石者洞穴或西部荒野最東南角的迪菲亞工蜂身上取得聖契。\n\n現在按照聖契的提示操作：用你的制裁之錘擊暈 10 個敵人。\n\n再次點擊聖契即可獲勝！"
st.paladin.runeOfAegis = "前往諾莫瑞根的入口，從鐵爐堡往西走很遠，和一個受傷的冒險者交談。\n\n"
			.."或者在艾爾文森林碧玉礦的最深處找到受傷的冒險者。\n\n"
			.."無論哪種方式，施放淨化 (8 級以上) 就完成了！"
st.paladin.martyrdom = "與暴風城的羅穆盧斯兄弟交談。\n\n按照他的指示，走西邊的樓梯到地下室。\n\n你可能需要等待字條出現。\n"
			.."它就在底部蠟燭的旁邊。\n\n艾達在西部荒野、暮色森林、艾爾文森林的河流交匯處。\n\n她有你的符文。你知道該怎麼做。"

-- 聖騎士 第二階段
st.paladin.guardedLight = "你必須已學習神聖干預 (30 級)。\n\n點擊骷髏並拾取休眠的聖符文後，對自己施放神聖干預並死亡。你可以在任何方便的地方這樣做。\n\n"
			.."另一名玩家必須復活你，不一定是聖騎士。你將自動獲得符文。\n\n"
			.."請注意，靈魂石對此無效。"
st.paladin.malleable = "黑鐵炸彈兵和供應商掉落所有三個污損的祈禱珠 I/II/III 的機率最高\n"
			.."(儘管掉落率仍然很低)。\n\n在戰鬥中施放力量祝福來淨化 I。\n"
			.."在生命值低於 10% 時使用神聖護盾來淨化 II。\n在逃跑時使用正義聖印和審判來淨化 III。\n\n"
			.."現在組合 -> 光明念珠。將念珠帶到\n斯通加德要塞的阿提克斯兄弟。"
st.paladin.sacredShield = "在安東兄弟的建築物內的一張長凳上。\n\n裝備然後對其他玩家/NPC 使用自由祝福 (18 級) 五次。必須是會阻礙移動的定身效果。例如，減速效果無效。\n\n"
			.."網是很好的選擇 - 西部荒野或濕地龍喉區域的魚人網捕者、瑪拉頓附近的瑪格拉姆馴獸師、黑海岸的灰霧網捕者等等。\n\n可以反覆對同一個朋友使用！"
st.paladin.sheathLight = "必須已獲得神聖風暴符文。稍後你將需要一把通往血色修道院大教堂側廳的鑰匙。\n\n"
			.."在瑪諾洛克海灣拾取一把華麗的戰錘，開始任務“破碎的戰錘”。\n\n"
			.."現在在附近擊殺燃燒之刃召喚師 (38-39 級) 以獲得撕裂的信件。前往暴風城大教堂的純潔者凱瑟琳 (左側的第一個房間)。聽她說“失蹤的兄弟”。\n\n"
			.."將你的爐石設定為暴風城，然後前往濕地的米奈希爾港碼頭，與哈羅德·里格斯交談。\n\n"
			.."向南游很長一段距離到紐曼碼頭。你會看到一棟建築物和一個碼頭。\n"
			.."這是丹莫羅的最西南角。\n\n"
			.."你會遭到伏擊。拾取命令並接取任務，然後爐石回到暴風城。與凱瑟琳交談。\n\n"
			.."現在在血色修道院的大教堂側廳擊敗大檢察官懷特邁恩。在你離開之前找到艾歐納斯！現在再次爐石，再次與凱瑟琳交談，你就差不多完成了。"

-- 聖騎士 第三階段
st.paladin.fanaticism = "從平反的艾歐尼斯處接取任務。\n他在暴風城大教堂。前往\n"
			.."塞拉摩，並痛擊埃爾里克。\n\n與嚴肅的酒吧顧客交談。\n\n"
			.."回到大教堂的純潔者凱瑟琳處，\n她會給你豐厚的獎勵。"
st.paladin.hammerRighteous = "在費伍德森林，你爬上繩索到達艾歐尼斯。接下來與格雷戈里交談並接受任務。\n\n"
			.."向北走，在碎鱗谷擊殺以獲得 3 個\n熾熱的地獄火核心。接下來在希爾斯布萊德丘陵塔倫米爾以北\n"
			.."見到牛頭人勇士石炬。你將獲得信仰的象徵。\n\n"
			.."閃爍的墓穴灰塵來自於一個墳堆，\n在瑪拉頓殺死瑟萊德絲公主後獲得。\n\n"
			.."三重釀造的熔火拉格啤酒可以從\n黑石深淵深處的格里姆·古茲勒酒館的\n普拉格·斯帕茲林購買。對於單人玩家來說，這是一系列漫長的跑屍之旅。\n\n"
			.."返回格雷戈里交任務。接受你的符文！"
st.paladin.lightsGrace = "你必須前往菲拉斯的一個無法進入的平台。你可以使用附近標記的傳送器，\n"
			.."或者藏寶海灣的另一個傳送器。藏寶海灣的傳送器需要解鎖。\n\n"
			.."傳送器會把你送到維達爾·奇齒輪附近。\n看向標記為“弗里克斯·齊齊克斯”的標記。\n"
			.."去找他。你必須通過被一個塔防自動裝置 (57 精英) 的擊退效果\n"
			.."到達他那裡，它與維達爾在同一個區域。將你與加基森的聲望設定為\n“交戰”。將自己放置在距離弗里克斯\n"
			.."最近的位置，並確保你盡可能背對你的飛行路線。\n\n"
			.."開始攻擊並祈禱。說真的。這是一場賭博。考慮卸下裝備以節省修理\n"
			.."費用，因為你可能需要多次嘗試。\n有一個討厭的沉默減益，因此無法使用保護祝福。\n\n"
			.."現在，與弗里克斯交談，他會派你到海灣\n與他的兄弟交談。符文就是你的了！"
st.paladin.wrath = "在辛特蘭奎爾丹尼爾旅館的北邊，\n聖騎士將使用他們的感知亡靈技能來\n"
			.."找到一個復仇之魂 (45 級)。殺死它。\n\n與鐵爐堡秘法區的法師法拉斯交談。好好享受吧！"

-- 聖騎士 第四/五階段
st.paladin.avengingWrath = "你在完成“震驚與敬畏”的同時\n獲得這本法術書！"
st.paladin.righteousness = "殺死一個鬆垮的食屍鬼，主要在主要的\n東西向道路西端以南。\n\n"
			.."你現在有奧薩斯陪伴。你也\n被賦予了隨意召喚奧薩斯的方法。\n\n"
			.."奧薩斯的錘子在科林十字路口\n房屋的上層。\n\n"
			.."(每一步你都應該召喚奧薩斯。)\n\n按照地圖尋找憎惡。你\n"
			.."想要一個部分消化的板甲掉落。\n\n接下來殺死斯坦索姆的蒼白馬萊基。\n\n"
			.."你接下來將前往地下室以\n完成這個任務鏈。\n\n"
st.paladin.shockAwe = "緊接在復仇符文之後。\n\n升級你的侍從的一個技巧是\n不停地施放聖光閃現！"
st.paladin.vengeance = "注意：兩個符文加上一本法術書是線性發生的。復仇 -> 震驚與敬畏 ->\n"
			.."復仇之怒。\n\n任務非常簡單，並且這個“樞紐”中的\n標記已編號。"
...
-- 通用階段 4
st.purchaseSkillBook = "從奧格瑞瑪智慧谷的佐爾·孤木 (部落) 或暴風城要塞圖書館的米爾頓·席夫 (聯盟) 處購買。"
st.skillBookVendor = "技能書可以從這個圖書館員處購買。"

-- 通用戒指階段 4/5
st.ring.defense = "從灼熱峽谷（或者可能是燃燒平原）\n沿著黑石山洞穴內的圓形路徑向下走，直到到達黑石塔\n"
			.."集合石。\n\n轉入那個走廊。然後在第一個右轉\n"
			.."進入一個小房間。地板上有兩本\n"
			.."這本書。你只需要拾取一本即可獲得你的豐厚戰利品。"
st.ring.defenseTip = "低等級玩家可以跑屍並拾取這本書，因為其中一本書可以在脫離怪物仇恨/視野的情況下拾取。"
st.ring.fire = "從瑟銀哨站向東南方向走。找到\n地面上的一個洞。跳進去。\n\n"
			.."轉身向北走，上坡道。\n\n在岔路口左轉。書在\n"
			.."壁龕裡的一張長凳上。"
st.ring.sword = "繞到卡拉贊的後面，找到\n"
			.."通往主人酒窖的正確入口，按照\n"
			.."標記所示。\n\n沿著樓梯往下走，進入地下墓穴。現在向\n右走，沿著路徑繞行。你來到\n"
			.."一個下坡通道，通往一個中央高台。\n\n在這個平台的左側是兩根柱子，\n"
			.."書就在它們之間。拾取以獲勝！"
...
st.dungeonSummary = "從血色修道院、剃刀高地和奧達曼的命名精英/Boss 身上掉落" -- 已棄用 P4
st.supplyFactionStart = "暴風城的伊萊恩·康普頓，“艾澤拉斯商業管理局商人”(聯盟)，\n"
			.."奧格瑞瑪的喬娜，“杜隆塔爾補給和後勤商人”(部落)"
st.twoPlusHealers = "2+ 玩家 - 治療者。第一步：找到冒險者的遺體/靈魂：\n"
