...
local trackerUILocales = {
    ...
    -- Misc Translations
    ["Quest Complete!"] = {
        ["ptBR"] = "Missão Completa!",
        ["ruRU"] = "Задание выполнено!",
        ["deDE"] = "Quest abgeschlossen!",
        ["koKR"] = "퀘스트 완료!",
        ["esMX"] = "¡Misión completa!",
        ["enUS"] = true,
        ["zhCN"] = "任务完成！",
        ["zhTW"] = "任務完成！",
        ["esES"] = "¡Misión completa!",
        ["frFR"] = "Quête Terminée !",
    },
    ["Quest Failed!"] = {
        ["ptBR"] = "Missão Falhou!",
    ...
    ["Quests (By %% Complete Reversed)"] = {
        ...
        ["koKR"] = false,
        ["esMX"] = "Misiones (Por %% completada inverso)",
        ["enUS"] = true,
        ["zhCN"] = "任务 (按完成度 %%反向）",
        ["zhTW"] = "任務 (依完成度 %% 反向)",
        ["esES"] = "Misiones (Por %% completada inverso)",
    ...
    ["Quests (By Proximity Reversed)"] = {
        ["ptBR"] = "Missões (Por proximidade invertido)",
        ["ruRU"] = "Задания (По близости убыв.)",
        ["deDE"] = "Quests (Nach Nähe Absteigend)",
        ["koKR"] = "퀘스트 (가까운 역순)",
        ["esMX"] = "Misiones (Por proximidad inverso)",
        ["enUS"] = true,
        ["zhCN"] = "任务（按远近反向）",
        ["zhTW"] = "任務 (依遠近 (反向)",
        ["esES"] = "Misiones (Por proximidad inverso)",
